...
import com.evoliteengine.render.shader.ParticleShader;
...
public class ParticleRenderer {
	...
	private static final FloatBuffer buffer = BufferUtils.createFloatBuffer(INSTANCED_DATA_LENGTH * MAX_INSTANCES);
	...
	public ParticleRenderer(Loader loader, Matrix4f projectionMatrix) {
		...
		loader.addInstanceAttribute(quad.getVaoID(), vbo, 1, 4, INSTANCED_DATA_LENGTH, 0);
		loader.addInstanceAttribute(quad.getVaoID(), vbo, 2, 4, INSTANCED_DATA_LENGTH, 4);
		loader.addInstanceAttribute(quad.getVaoID(), vbo, 3, 4, INSTANCED_DATA_LENGTH, 8);
		loader.addInstanceAttribute(quad.getVaoID(), vbo, 4, 4, INSTANCED_DATA_LENGTH, 12);
		loader.addInstanceAttribute(quad.getVaoID(), vbo, 5, 4, INSTANCED_DATA_LENGTH, 16);
		loader.addInstanceAttribute(quad.getVaoID(), vbo, 6, 1, INSTANCED_DATA_LENGTH, 20);
	...
	private void updateModelViewMatrix(Vector3f position, float rotation, float scale,
		...
		Matrix4f.rotate((float) Math.toRadians(rotation), new Vector3f(0, 0, 1),
