...
public class Entity {
	...
	public float getTextureXOffset() {
		...
		return (float) column / (float) model.getMaterial().getNumberOfRows();
	}

	public float getTextureYOffset() {
		int row = textureIndex / model.getMaterial().getNumberOfRows();
		return (float) row / (float) model.getMaterial().getNumberOfRows();
	}
